...
contract AegisNexus 
{
    //Decalring all data structures and variables
    ...
    //Declaring all custom modifiers
    modifier onlyOwner() 
    {
        if (msg.sender != owner) {
    ...
    //Initialising the contract using a constructor which sets the owner of the contract to the address of the sender
    constructor() 
    { 
        owner = msg.sender; 
    }
